		...
		<div class="relative z-10 lg:grid lg:grid-cols-12 lg:items-center lg:gap-16">
			<div class="mb-10 lg:order-2 lg:col-span-6 lg:col-start-8 lg:mb-0">
				...
				>
					<button
						type="button"
						class="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent active rounded-xl p-4 text-start hover:bg-gray-200 focus:bg-gray-200 focus:outline-hidden md:p-5"
					...
					>
						<span class="flex gap-x-6">
							<svg
								class="hs-tab-active:text-blue-600 mt-2 size-6 shrink-0 text-gray-800 md:size-7"
							...
							>
							<span class="grow">
								<span class="hs-tab-active:text-blue-600 block text-lg font-semibold text-gray-800"
									>Advanced tools</span
								>
								<span class="mt-1 block text-gray-800"
									>Use Preline thoroughly thought and automated libraries to manage your businesses.</span
								>
							</span>
						</span>
					</button>
					...
					<button
						type="button"
						class="hs-tab-active:bg-white hs-tab-active:shadow-md hs-tab-active:hover:border-transparent rounded-xl p-4 text-start hover:bg-gray-200 focus:bg-gray-200 focus:outline-hidden md:p-5"
